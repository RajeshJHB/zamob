...
use App\Http\Controllers\Settings\ContactCategoryController;
...
Route::middleware(['auth', 'verified', 'role.assigned'])->group(function () {
    ...
    Route::get('/settings/contacts', [ContactSettingsController::class, 'index'])->name('settings.contacts.index');
    Route::get('/settings/contact-categories', [ContactCategoryController::class, 'index'])->name('settings.contact-categories.index');
    Route::post('/settings/contact-categories', [ContactCategoryController::class, 'store'])->name('settings.contact-categories.store');
    Route::put('/settings/contact-categories/{contactCategory}', [ContactCategoryController::class, 'update'])->name('settings.contact-categories.update');
    Route::delete('/settings/contact-categories/{contactCategory}', [ContactCategoryController::class, 'destroy'])->name('settings.contact-categories.destroy');
